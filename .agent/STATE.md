...
- `index.html`, `speisekarte.html`, `styles.css`
...
preserved the real launch tasks, and separated verified Pages preview status from
the still-unmigrated public domain.
